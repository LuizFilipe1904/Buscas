...
public class BuscaSequencial {
    public static void main(String[] args) {
        ...
        System.out.println("Executando testes para 10 mil numeros: ");
            ...
            long totalDezMil = endDezMil - startDezMil; //Calcula o tempo gasto em nanosegundos
            long convertDezMil = TimeUnit.SECONDS.convert(totalDezMil, TimeUnit.NANOSECONDS); //Converte os nanosgundos para segundos
            System.out.println("Foram gastos " + convertDezMil + " segundos");
        
        
        //100 mil números
        System.out.println("Executandos testes para 100 mil numeros: ");
